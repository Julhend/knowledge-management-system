        ...
        <div class="row">
            ...
            <div class="breadcrumb-container">
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a
                            href="{{ route('categories.show', [$article->category->slug, $article->category->id]) }}">{{ $article->category->name }}</a>
                    </li>
            ...
            <div class="panel-transparent">
                ...
                <div class="article-content">
                    <div class="btn-group">
                        <button class="btn btn-default" id="button-comment"> <i class="fa fa-comment-o"></i> Leave a
                            Comment</button>
                    </div>
                    <form action="" style="margin-top:10px;display:none;" method="POST" class="comment-form"
                        ...
                        <br>
                        <textarea rows="4" name="content" placeholder="Your Comment"></textarea>
            ...
            <div class="panel panel-default">
                ...
                <div class="article-content">
                    <div class="article-comment-top">
                        @foreach ($article->comments()->orderBy('created_at', 'desc')->get()->where('parent', 0)
        as $comment)
